...
res3() {
wget https://raw.githubusercontent.com/makhroja/newsc/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}
...
res7() {
wget https://raw.githubusercontent.com/makhroja/newsc/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/makhroja/newsc/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
}
